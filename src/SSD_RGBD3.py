...
def RGBD_SSD300(input_shape, depth_input_shape, num_classes=21):
 ...
 #                    weights=[weights[0], weights[1]]
    ...
    conv1_3 = Add()([conv1_2, depth_conv1_2])
    ...
    conv2_3 = Add()([conv2_2, depth_conv2_2])
    ...
    conv3_4 = Add()([conv3_3, depth_conv3_3])

    pool3 = MaxPooling2D(name='pool3',
                         pool_size=(2, 2),
                         strides=(2, 2),
                         padding='same')(conv3_4)
    ...
    conv4_4 = Add()([conv4_3, depth_conv4_3])

    pool4 = MaxPooling2D(name='pool4',
                         pool_size=(2, 2),
                         strides=(2, 2),
                         padding='same')(conv4_4)
