    ...
    while True:
        ...
        if iter_num == epoch_length:
            ...
            if curr_loss < best_loss:
                ...
                best_loss = curr_loss
                model.save_weights('/media/jun/checkpoints/SUNRGBD/RGBD/v15/weights-v15.{epoch:02d}-{val_loss:.2f}.hdf5'.format(epoch=epoch, val_loss=best_loss))
            iter_num = 0
            break
