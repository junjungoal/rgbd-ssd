    ...
    while True:
        ...
        if iter_num == epoch_length:
            ...
            if curr_loss < best_loss:
                ...
                best_loss = curr_loss
                model.save_weights('/data/jun/checkpoints/SUNRGBD/RGBD/v24/weights-v24.{epoch:02d}-{val_loss:.2f}.hdf5'.format(epoch=epoch, val_loss=best_loss))
            iter_num = 0
            break
